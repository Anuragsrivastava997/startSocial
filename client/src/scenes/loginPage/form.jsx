...
function Form() {
  ...
  const saveLogin = async (values, onSubmitProperties) => {
  ...
  const saveRegister = async (values, onSubmitProperties) => {
  ...
  const handleFormSubmit = async (values, onSubmitProperties) => {
    await (isLogin
      ? saveLogin(values, onSubmitProperties)
      : saveRegister(values, onSubmitProperties));
  };
